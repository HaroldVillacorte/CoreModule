...
<fieldset>
    ...
    <input type="text" name="user_activation_expire_limit" class="<?php echo form_error_class('user_activation_expire_limit') ;?>"
           value="<?php echo (variable_get('user_activation_expire_limit')) ?
           variable_get('user_activation_expire_limit') : set_value('user_activation_expire_limit');?>" />
    ...
    <input type="text" name="user_forgotten_password_code_expire_limit" class="<?php echo form_error_class('user_forgotten_password_code_expire_limit') ;?>"
           value="<?php echo (variable_get('user_forgotten_password_code_expire_limit')) ?
           variable_get('user_forgotten_password_code_expire_limit') : set_value('user_forgotten_password_code_expire_limit');?>" />
...
<fieldset>
    ...
    <input type="text" name="user_persistent_cookie_name" class="<?php echo form_error_class('user_persistent_cookie_name') ;?>"
       value="<?php echo (variable_get('user_persistent_cookie_name')) ?
       variable_get('user_persistent_cookie_name') : set_value('user_persistent_cookie_name');?>" />
    ...
    <input type="text" name="user_persistent_cookie_expire" class="<?php echo form_error_class('user_persistent_cookie_expire') ;?>"
       value="<?php echo (variable_get('user_persistent_cookie_expire')) ?
       variable_get('user_persistent_cookie_expire') : set_value('user_persistent_cookie_expire');?>" />
...
<fieldset>
    ...
    <input type="text" name="user_login_attempts_max" class="<?php echo form_error_class('user_login_attempts_max') ;?>"
       value="<?php echo (variable_get('user_login_attempts_max')) ?
       variable_get('user_login_attempts_max') : set_value('user_login_attempts_max');?>" />
    ...
    <input type="text" name="user_login_attempts_time" class="<?php echo form_error_class('user_login_attempts_time') ;?>"
       value="<?php echo (variable_get('user_login_attempts_time')) ?
       variable_get('user_login_attempts_time') : set_value('user_login_attempts_time');?>" />
    ...
    <input type="text" name="user_login_attempts_lockout_time" class="<?php echo form_error_class('user_login_attempts_lockout_time') ;?>"
       value="<?php echo (variable_get('user_login_attempts_lockout_time')) ?
       variable_get('user_login_attempts_lockout_time') : set_value('user_login_attempts_lockout_time');?>" />
