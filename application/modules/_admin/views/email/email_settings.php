...
<?php echo form_open('_admin/email_settings') ;?>

<label for="core_email_Host" >Host:</label>
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Host') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Port') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_SMTPSecure') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Username') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Password') ;?>"
       type="password" name="core_email_Password" value="" />

<label for="core_email_From" >From email:</label>
<input class="<?php echo $this->core_module_library->form_error_class('core_email_From') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_FromName') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Freply_to') ;?>"
...
<input class="<?php echo $this->core_module_library->form_error_class('core_email_Freply_to_name') ;?>"
