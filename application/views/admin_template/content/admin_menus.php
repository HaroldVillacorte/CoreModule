...
<table width="100%">
    <thead>
        <tr>
            ...
            <th width="10%"><a class="label secondary" href="<?php echo base_url() . $this->core_menu_library->menu_add_uri ;?>">Add menu +</a></th>
        </tr>
    </thead>
    <tr>
        ...
        <td>
            ...
            <a class="label round" href="<?php echo base_url() . $this->core_menu_library->menu_edit_uri . $menu->id ;?>">Edit</a>&nbsp
            <a class="label alert round" href="<?php echo base_url() . $this->core_menu_library->menu_delete_uri . $menu->id ;?>"
...
<table width="100%">
    <thead>
        <tr>
            ...
            <th>Link</th>
            <th>Permissions</th>
            <th><a class="label secondary" href="<?php echo base_url() . $this->core_menu_library->menu_link_add_uri . $menu->id ;?>">Add link +</a></th>
        </tr>
    </thead>
    <tbody id="table1">
