...
<input class="<?php echo form_error_class('core_email_Host') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_Host)) ? $settings->core_email_Host : set_value('core_email_Host') ;?>" />

<label for="core_email_Port" >Port:</label>
<input class="<?php echo form_error_class('core_email_Port') ;?>"
       type="text" name="core_email_Port"
       value="<?php echo (isset($settings->core_email_Port)) ? $settings->core_email_Port : set_value('core_email_Port') ;?>" />

<label for="core_email_SMTPAuth" >Authorization required:</label>
<input type="checkbox" name="core_email_SMTPAuth" value=1
       <?php echo (isset($settings->core_email_SMTPAuth) && $settings->core_email_SMTPAuth == 1) ? 'checked="checked"' : set_checkbox('core_email_SMTPAuth') ;?> />
...
<input class="<?php echo form_error_class('core_email_SMTPSecure') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_SMTPSecure)) ? $settings->core_email_Port : set_value('core_email_SMTPSecure') ;?>" />
...
<input class="<?php echo form_error_class('core_email_Username') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_Username)) ? $settings->core_email_Username : set_value('core_email_Username') ;?>" />
...
<input class="<?php echo form_error_class('core_email_From') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_From)) ? $settings->core_email_From : set_value('core_email_From') ;?>" />
...
<input class="<?php echo form_error_class('core_email_FromName') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_FromName)) ? $settings->core_email_FromName : set_value('core_email_FromName') ;?>" />
...
<input class="<?php echo form_error_class('core_email_reply_to') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_reply_to)) ? $settings->core_email_reply_to : set_value('core_email_reply_to') ;?>" />
...
<input class="<?php echo form_error_class('core_email_reply_to_name') ;?>"
       ...
       value="<?php echo (isset($settings->core_email_reply_to_name)) ? $settings->core_email_reply_to_name : set_value('core_email_reply_to_name') ;?>" />
